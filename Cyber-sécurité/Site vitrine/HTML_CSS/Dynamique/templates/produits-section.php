          ...
          <article id="produit-<?php echo (int) $produit['id']; ?>"
            ...
            <div class="flex items-start justify-between gap-3 mb-4">
              <div class="flex-1 min-w-0">
                ...
                <h3 class="mt-1 text-lg font-extrabold text-slate-900 break-words">
              ...
              <?php if ((int) $produit['stock'] > 0): ?>
                <span
                  ...
                  stock (<?php echo (int) $produit['stock']; ?>)</span>
              <?php else: ?>
                <span
            ...
            <p class="text-sm text-slate-600 line-clamp-3 mb-6 flex-1">
              <?php echo htmlspecialchars($produit['descriptif']); ?>
            </p>
            ...
            <div class="mt-auto pt-5 border-t border-slate-100 flex items-center justify-between gap-4">
              <div class="shrink-0">
                ...
                <div class="text-lg font-extrabold text-slate-900">
                  <?php echo format_prix($produit['prix']); ?>
                </div>
              </div>

              <div class="flex items-center gap-2">
                <a href="#modal-<?php echo (int) $produit['id']; ?>"
                  class="rounded-2xl border border-slate-300 bg-white px-3 py-2 text-xs font-bold text-slate-900 hover:bg-slate-50">
                  Détails
                </a>

                <?php if ((int) $produit['stock'] > 0): ?>
                  <form method="post" action="/panier.php" class="flex items-center gap-2">
                    <input type="hidden" name="action" value="add">
                    <input type="hidden" name="id" value="<?php echo (int) $produit['id']; ?>">
                    <input type="hidden" name="return_to" value="/index.php#produit-<?php echo (int) $produit['id']; ?>">
                    <button type="submit"
